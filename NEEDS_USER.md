...
## 👁️ 0א. בדיקה של דקה שרק אתה יכול לעשות — צילומי הבניין בנדל"ן

תיקנתי את הבאג שהמפרט מציין בשמו: צילום הבניין הופנה לכיוון ברירת המחדל של
הפנורמה (כיוון הרחוב) במקום אל הבניין. עכשיו הכיוון מחושב מעמדת המצלמה אל
הנכס, ואומת חישובית על ארבע כתובות הבדיקה — פער של 0.01° מול חישוב עצמאי.

**מה שאני לא יכול לאמת: איך התמונה נראית.** הרשת כאן מסננת דרך נטפרי, וכל
תמונה מוחלפת במציין מקום 640×500 ("כעת התמונה נשלחה לנטפרי לבדיקה") — גם
בדפדפן. כלומר הגיאומטריה מאומתת, המראה לא.

**מה לעשות:** לפתוח את ארבע הכתובות ולוודא שהצילום מראה את הבניין הנכון
(הצד הנכון של הרחוב, במספר הבית הנכון):
`more30.com/nadlan/report?q=דורש טוב 17 ירושלים` · `שמואל הנביא 86 ירושלים` ·
`הדקל 22 חצור הגלילית` · `הבעל שם טוב 9 רחובות`.
אם אחד מהם עדיין מסתכל לצד הלא נכון — תגיד לי איזה, ואכוון אותו ידנית
(המסלול כבר תומך ב-`?heading=` מפורש).
