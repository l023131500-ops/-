// אותו הרכב כמו dropped-labels-0814: 8148 מגיש את הגרסה שבייצור
// (git show HEAD) ו-8149 את הקובץ המתוקן. שניהם מדברים אל אותו edge חי —
// ENDPOINT ב-index.html הוא כתובת מוחלטת — ולכן ההבדל שנמדד יכול להיות רק בין
// שתי גרסאות של המסך.
//
