...
const cb = `?cachebust=search-label-${phase}`;
const URLS = [
...
// ⚠️ הטענה שאין לה תחליף: הטענה השגויה יצאה. לפני — ≥1 בייצור; אחרי — 0.
...
writeFileSync(`${ROOT}/QA/bkalot-clone/search-label-deploy-0816/${phase}.json`, JSON.stringify(out, null, 2));
