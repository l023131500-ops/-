...
//
// שישה מסומנים של 978ab68 (בורר המכתב), וששה של הפעימות הקודמות — כדי שהמדידה
// תראה גם רגרסיה ולא רק את התוספת.
const M = [
  "ברירת מחדל לפי סוג הפנייה", "tmpl-sel", "מנוטרלת, אינה מפיקה",
  "ערוץ התבנית", "נקבע לפי סוג הפנייה", "template_key",
  "שינוי סטטוס", "עבד עכשיו", "<th>תור</th>", "כתובת המכתב",
