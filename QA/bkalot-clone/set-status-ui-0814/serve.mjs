...
// זו מדידה של הקוד ולא של המוצר — ה-rewrite ב-vercel.dist.json, ההעתקה ל-dist
// ו-236 הבייטים ש-NetFree מזריק אינם נבדקים כאן. הפריסה היא הצעד הבא, כמו
// בכל לבנה כאן (c2a0a36→205c940, 18006b1→55efb75, 37235a3→e95a0ef).
