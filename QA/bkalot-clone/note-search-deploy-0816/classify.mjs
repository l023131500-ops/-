...
const CAND = [
  // מועמדי NEW — נולדו ב-e73fc63
  "noteMatchBit", "נמצאה לפי הנימוק", "matched_in_note", "Object.hasOwn",
  "הוא נמצא בנימוק שנכתב ביומן ההכרעות", "פתחו את הפנייה כדי לקרוא אותו",
  "ראשון מבין הסימנים ולא אחרון", "0096",
  "והמסך אינו רשאי להמציא אותו",
  // מועמדי DIFF — קיימים בייצור והלבנה החדשה משתמשת בהם שוב
  "decidedBit", "meta.append", "s.className = \"stale\"", "0091",
  // מועמדי בקרה — מסומני ה-NEW של 2840dd7 (מה שהלבנה הקודמת פרסה) ועוד ותיקים
  ...
  "list-error", "why-input", "td.why", "רצף ההכרעות",
