// זריעה למדידת הפריסה של 0096+e73fc63 — «נמצאה לפי הנימוק» נאמר בשורה בייצור.
//
...
//
// שתי הפניות והנימוקים הם מילה במילה אלה שנמדדו ב-0096 וב-e73fc63 — אותו טקסט
// בדיוק, כדי שהמדידה בייצור תרוץ על מה שכבר נמדד במסד ומול שרת מקומי, ולא על
// מקרה אחר.
//
// kind=info ולא treatment: info אינו מחבר זכויות, ולכן שתי קליטות אינן גוררות
// 84 שורות case_rights לגלגול אחורה.
//
