// אותו הרכב כמו badinput-topic-no-0814: 8154 מגיש את הגרסה שבייצור
// (git show HEAD) ו-8155 את הקובץ המתוקן. שניהם מדברים אל אותו edge חי ואל
// אותו מסד — ENDPOINT ב-index.html הוא כתובת מוחלטת — ולכן ההבדל שנמדד יכול
// להיות רק בין שתי גרסאות של המסך.
//
