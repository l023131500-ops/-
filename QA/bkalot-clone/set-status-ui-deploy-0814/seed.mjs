...
//   A — הפנייה שכפתורי הסטטוס ייבחנו עליה בייצור
//   B — הבקרה. לא נוגעים בה כלל, והיא חייבת להישאר «חדשה» עד הסוף.
...
const cases = [
  ["A", { kind: "treatment", source: "form", full_name: "רבקה בדיקה", phone: "0500075001",
          email: "qa.bkalot@more30.com", note: "הפנייה שהסטטוס שלה ישונה מהמסך החי", consent: "true", situation: "disability" }],
  ["B", { kind: "treatment", source: "form", full_name: "לאה בדיקה", phone: "0500075002",
...
writeFileSync("C:/Users/USER/Downloads/more30/QA/bkalot-clone/set-status-ui-deploy-0814/seed-out.txt", out.join("\n") + "\n", "utf8");
