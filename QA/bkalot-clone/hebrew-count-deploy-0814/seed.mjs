// זריעה לפעימת הפריסה של «זכות אחת / מסמך אחד».
//
...
const caseOne = await mk("בדיקה 0083 יחיד", "פריסת ספירה בעברית — תרד לזכות אחת ולמסמך אחד", "0501230097");
const caseMany = await mk("בדיקה 0083 רבים", "פריסת ספירה בעברית — בקרה שנשארת ברבים", "0501230098");
