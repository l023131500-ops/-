...
//
// שלוש פניות, שלושה טלפונים שונים — שלושת המצבים שהכפתור החדש צריך להבחין
// ביניהם על המסך:
...
const cases = [
  ["A", { kind: "treatment", source: "form", full_name: "מרים בדיקה", phone: "0500073001",
          email: "qa.bkalot@more30.com", note: "השורה שתעובד מהמסך", consent: "true", situation: "disability" }],
  ["B", { kind: "treatment", source: "form", full_name: "נעמי בדיקה", phone: "0500073002",
          email: "qa.blocked.0073@more30.com", note: "יעד שאינו ברשימה", consent: "true", situation: "disability" }],
  ["C", { kind: "treatment", source: "form", full_name: "שרה בדיקה", phone: "0500073003",
...
writeFileSync("C:/Users/USER/Downloads/more30/QA/bkalot-clone/dispatch-ui-0814/seed-out.txt", out.join("\n") + "\n", "utf8");
