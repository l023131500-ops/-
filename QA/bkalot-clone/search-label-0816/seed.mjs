// זריעה למדידת התווית: פנייה אחת, ובתוכה נימוק שנושא מילה שאינה בשם, אינה
// בטלפון, אינה במייל ואינה במספר הפנייה. זה בדיוק המקרה שהתווית מכחישה — היא
// מונה ארבעה שדות, והשורה תעלה בזכות שדה חמישי.
//
...
const r = await post(FN + "/bkalot-clone-intake", {
  ...
  email: "test@more30.com", note: "פנייה שהתווית מעל תיבת החיפוש נמדדת עליה", consent: "true",
});
