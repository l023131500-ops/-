...
const CAND = [
  // מועמדי NEW — נולדו ב-02fc51c
  "q-phone", "qnote", "qPhone", "חיפוש הטלפון רץ על הספרות בלבד", "חופש לפי",
  "הקלדתי עם מקפים", "border-inline-start", "אין פנייה כזו",
  // מועמדי DIFF — קיימים בייצור וההערה החדשה מזכירה אותם שוב
  "q_phone", "0093", "class=\"code\"", "role=\"status\"", "list-error",
  // מועמדי בקרה
  "decider_required", "note_too_long", "why-input", "syncNoteCount", "td.why",
  "רצף ההכרעות", "handsBit", "producedBit", "fillQueueCell", "fillTemplateCell",
