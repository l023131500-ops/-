// זריעה למדידת המסך: שתי פניות ולא אחת. באחת איש הקשר יימחק ובשנייה לא, כדי
// שההשוואה תהיה בתוך אותה רשימה ובאותו צילום — שורה בלי זהות לצד שורה עם זהות,
// ולא שני צילומים של שני מצבים שאי אפשר להניח זה על זה.
//
...
// נאמר ולא נבלע — המדידה כאן היא של המסך, והמחיקה היא פיגום.
//
