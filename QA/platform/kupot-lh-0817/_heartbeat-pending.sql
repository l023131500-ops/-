...
values (
  ...
  'kupot-lh-0817',
  'done',
  '28 השוואת קופות: Lighthouse נמדד לראשונה (perf 65, a11y כבר 100, SEO 100, BP 77). נגישות כבר מלאה - אין ליקוי לתקן. פרפורמנס מתחת לסף 90 תואם דפוס NetFree/third-party-cookies שכבר מתועד. commit ffe8867. heartbeat written late from file - MCP was down this session.'
);
