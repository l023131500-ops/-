 ...
 *
 * הכפתור יושב בתוך המסגרת בצד שמאל: העמוד RTL, והצד הימני של השדה כבר תפוס
 * באייקון ה-Lock שמעליו — כפתור שיושב שם היה מכסה אותו. `pl-10` שומר שהתווים
 * לא ייכנסו מתחת לכפתור.
 *
