    ...
    <footer className="bg-gradient-navy text-primary-foreground relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 py-14 relative">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            <h4 className="font-heading font-bold text-secondary mb-4">ניווט מהיר</h4>
          ...
          <div>
            <h4 className="font-heading font-bold text-secondary mb-4">למגידי שיעורים</h4>
            <div className="flex flex-col gap-2">
          ...
          <div>
            <h4 className="font-heading font-bold text-secondary mb-4">צור קשר</h4>
