        ...
        <div className="container mx-auto px-4 max-w-2xl">
          ...
          <form onSubmit={handleSubmit} className="bg-card rounded-3xl p-8 md:p-10 shadow-elegant border border-border space-y-5">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div><label className="text-sm font-medium text-foreground mb-1 block">טלפון *</label><Input required type="tel" placeholder="050-0000000" value={form.phone} onChange={e => setForm(p => ({...p, phone: e.target.value}))} /></div>
            </div>
