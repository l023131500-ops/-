      ...
      <div className="relative z-10">
        ...
        <div className="min-h-[45vh] flex flex-col items-center justify-center px-6 py-14">
          ...
          >
            ...
            {portal.logo_url ? (
              <img src={portal.logo_url} alt={portal.synagogue_name ? `לוגו ${portal.synagogue_name}` : "לוגו"} className="w-[140px] h-[140px] rounded-2xl object-cover border-4 border-gold/30 shadow-2xl" />
            ) : (
