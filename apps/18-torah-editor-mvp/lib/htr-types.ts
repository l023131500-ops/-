...
/**
 * תקרת הגודל להעלאת תמונה — מקור אמת יחיד לשרת ולדפדפן.
 *
 * הייתה רק בשרת (route.ts), והלקוח לא ידע עליה. לכן הלקוח היה יכול לבנות
 * קובץ גדול מהתקרה, לשלוח אותו במלואו, ורק בסוף לקבל 413. עכשיו שני הצדדים
 * קוראים את אותו מספר.
 */
export const HTR_MAX_UPLOAD_BYTES = 15 * 1024 * 1024; // 15MB
