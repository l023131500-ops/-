    ...
    <div className="space-y-6 rounded-2xl border border-border/40 bg-card p-6 shadow-card">
      ...
      <div className="grid gap-6 xl:grid-cols-[1.3fr_0.7fr]">
        <div className="grid grid-cols-1 gap-3 md:grid-cols-2">
          <div><label className="mb-1 block text-sm font-bold text-foreground">שם בית הכנסת</label><Input value={synagogue.name} onChange={(e) => setSynagogue({ ...synagogue, name: e.target.value })} /></div>
          <div><label className="mb-1 block text-sm font-bold text-foreground">שכונה</label><Input value={synagogue.neighborhood} onChange={(e) => setSynagogue({ ...synagogue, neighborhood: e.target.value })} /></div>
          <div><label className="mb-1 block text-sm font-bold text-foreground">נוסח</label><Input value={synagogue.nusach} onChange={(e) => setSynagogue({ ...synagogue, nusach: e.target.value })} /></div>
          <div><label className="mb-1 block text-sm font-bold text-foreground">רב בית הכנסת</label><Input value={synagogue.rabbi} onChange={(e) => setSynagogue({ ...synagogue, rabbi: e.target.value })} /></div>
          <div className="md:col-span-2"><label className="mb-1 block text-sm font-bold text-foreground">כתובת</label><Input value={synagogue.address} onChange={(e) => setSynagogue({ ...synagogue, address: e.target.value })} /></div>
          <div><label className="mb-1 block text-sm font-bold text-foreground">קישור תרומה</label><Input dir="ltr" value={synagogue.donation_link} onChange={(e) => setSynagogue({ ...synagogue, donation_link: e.target.value })} /></div>
          <div><label className="mb-1 block text-sm font-bold text-foreground">רקע (1-5)</label><Input type="number" min={1} max={5} value={synagogue.background_preset} onChange={(e) => setSynagogue({ ...synagogue, background_preset: Math.min(5, Math.max(1, Number(e.target.value) || 1)) })} /></div>
        </div>
