    ...
    <div className="mx-auto max-w-5xl px-5 py-10">
      ...
      <div className="mt-5 grid gap-4 sm:grid-cols-3">
        ...
        <PlanCard
          ...
          price="12 ₪ / חודש"
          highlight
          features={['תעודת זהות מלאה (7 שכבות)', 'היסטוריה רב-שנתית + גרפים', 'היתרים, זכויות ותוכניות', 'דירות מוצעות כרגע באזור']}
        />
        <PlanCard
          name="VIP"
          price="15 ₪ / חודש"
          features={['כל מה שבפרימיום', 'צילום הבניין ומפה אזורית מלאה', 'תשואת שכירות משוערת + נסח טאבו לפי דרישה', 'מצגת ללקוח + גרסה להדפסה']}
        />
      </div>
      <p className="mt-4 text-sm">
        <a
          href="https://more30.com/subscribe?app=nadlan"
          className="font-bold text-tealD hover:underline"
        >
          לפרטי המסלולים והרשמה ←
        </a>
      </p>
