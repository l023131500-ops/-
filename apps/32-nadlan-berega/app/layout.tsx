...
// היה @import url(fonts.googleapis.com) בתוך globals.css — שרשרת חסימה
// (HTML → CSS מבודל → CSS של Google → WOFF2 של gstatic) שמדדה FCP/LCP 5.0s
// ב-Lighthouse. next/font מטמיע את הגופנים בבנייה עצמה: אין בקשת רשת
// לגוגל בזמן ריצה, ואין שרשרת-תלות.
const heebo = Heebo({
