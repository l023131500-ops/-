...
// 19/08). זה נשאר נכון: אין כאן עדיין תזמון (Vercel Cron / pg_cron) — זה
// היקף גדול יותר מצעד אחד, ונשאר לצעד הבא. מה שיש כאן הוא המנוע שהתזמון
// יפעיל בעתיד, ומופעל **כרגע** ידנית ממרכז השליטה (`/admin`), באותו דפוס
// בדיוק שכבר קיים לתור הבקשות — הפקה+שליחה כפעולה אחת שאדמין מפעיל.
//
