...
const features = [
  ...
  { t: "מדף הגננת — ארכיון חומרים", d: "אלפי חומרים אמינים — דפי עבודה, צביעה, יצירה וחומרי חג — מסודרים לפי סדר השנה, לצפייה והורדה. אפשר גם להוסיף חומרים משלכם.", i: '<path d="M3 7h18M3 12h18M3 17h18"/><path d="M5 7v10M19 7v10"/>', c: "#eef2fb", col: "#2b4a8b" },
  { t: "מחולל דפי משימה AI", d: "בחרי נושא, גיל וסוג פעילות — וקבלי מתווה מלא לדף העבודה: הוראות לילדים, תוכן הדף והנחיות עיצוב.", i: '<path d="M14 3v4a1 1 0 0 0 1 1h4"/><path d="M17 21H7a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h7l5 5v11a2 2 0 0 1-2 2z"/><path d="M9 13h6M9 17h4"/>', c: "#eef2fb", col: "#2b4a8b" },
  { t: "דפי קשר להורים", d: "הקלידי את נושאי השבוע וקבלי טיוטת דף קשר חמה ויהודית, מנוסחת ומוכנה להעתקה.", i: '<path d="M21 15a2 2 0 0 1-2 2H8l-4 4V5a2 2 0 0 1 2-2h13a2 2 0 0 1 2 2z"/>', c: "#eef2fb", col: "#2b4a8b" },
  { t: "לוח שנה עברי חכם", d: "זיהוי אוטומטי של הפרשה, החג וראש החודש — ונושאים מומלצים לכל שבוע.", i: '<rect x="3" y="5" width="18" height="16" rx="2"/><path d="M3 9h18M8 3v4M16 3v4"/>', c: "#eef2fb", col: "#2b4a8b" },
  { t: "מותאם לסינון נטפרי", d: "רינדור בצד שרת, נכסים מקומיים — עובד גם תחת סינוני אינטרנט מחמירים.", i: '<path d="M12 3l7 3v6c0 4-3 7-7 9-4-2-7-5-7-9V6z"/><path d="M9 12l2 2 4-4"/>', c: "#eef2fb", col: "#2b4a8b" },
];
