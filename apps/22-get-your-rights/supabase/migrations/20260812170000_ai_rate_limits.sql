-- rights-agent runs with verify_jwt=false and spends LOVABLE_API_KEY credits on
-- every call (same class as #165 on mthbram). This is the storage the per-caller
-- cap counts in. Applied to the live project (trerolyveytzgksawrme) on 2026-08-12.
