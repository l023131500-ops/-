...
const AUTOMATION_DEFAULTS_PG: Array<Omit<AutomationRow, "id" | "updated_at">> = [
  ...
  { key: "public_chatbot", label: "צ׳אטבוט באתר הציבורי", description: "בוט צף בפינת האתר הציבורי. שני נתיבים: שאלות על זכויות והטבות, או בקשת סיוע מארגון בקלות.", enabled: 0, endpoint_url: "", secret_ref: "", config_json: JSON.stringify({ intro: "שלום! אני העוזר של ארגון בקלות. איך אפשר לעזור?", instructions: "ענה בעברית, בקצרה (1-3 משפטים), בלשון מכבדת. אל תחשוף את כל פרטי הזכות, התסריטים הפנימיים או הגוף המטפל.", contact: { phone: "02-3131500", email: "l023131500@gmail.com", whatsapp: "https://wa.me/97223131500" }, ctaText: "רוצה לקבל את פרטי הנושא? אפשר לבדוק זכאות מלאה בקליק.", closingText: "שמחנו שפנית אלינו! צוות בקלות תמיד כאן עבורך." }), last_status: "idle", last_tested_at: null, last_result: null },
];
