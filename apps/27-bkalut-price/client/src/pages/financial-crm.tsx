...
import type { FinClient, FinTask, FinMessage, FinDocument, FinReminder, FinReport, FinActivityLog, FinAlert } from "@shared/schema";
...
type Tab = "tasks" | "messages" | "documents" | "reminders" | "reports" | "alerts" | "activity";
