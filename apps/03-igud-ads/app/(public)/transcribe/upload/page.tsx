    ...
    <div className="min-h-screen bg-slate-50">
      ...
      <main id="main" className="container-rtl py-12">
        <div className="max-w-2xl mx-auto">
          ...
          {error && (
            <div role="alert" aria-live="assertive" className="bg-red-50 border border-red-200 text-red-700 px-4 py-3 rounded-lg mb-6">
              {error}
            </div>
          )}
          ...
          {step === 2 && couponInfo && (
            <form onSubmit={submitUpload} className="card space-y-6">
              ...
              <div>
                <label className="label" htmlFor="upload-file">קובץ אודיו</label>
                <input
                  id="upload-file"
                  type="file"
                  accept="audio/*,video/*"
