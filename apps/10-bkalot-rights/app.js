...
/* ---------- Config ---------- */
/* כתובת אתר השוואות המחירים — כשיעלה לאוויר, מלאו כאן את הכתובת */
const PRICES_URL = '';
/* כתובת אתר הניהול (Admin) של בקלות */
const ADMIN_URL = 'https://www.perplexity.ai/computer/a/bqlvt-tr-nyhvl-ji13g6HRRMWpasDyP_q3Ig';
