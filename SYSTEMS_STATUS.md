...
>
> 🔴 **מכסת הפריסות של Vercel (100/יום) נגמרה שוב אחרי 7 פריסות.** כל מה
> שלמטה מסומן ⏳ **כתוב, נבנה ומוכן בתיקיית ה-staging** — חסר רק
> `vercel deploy --prod`. רשימה מדויקת ב-`NEEDS_USER.md` §0ג.
...
| **02 · 03 · 06 · 10 · 35** | פלטה קבועה בלי הפשטה סמנטית, כמו nadlan לפני השכתוב. דורש את אותו שכתוב לכל אחת. **טרם בוצע.** | 🔶 פתוח |
