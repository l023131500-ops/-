...
> | **בקלות (10) — כניסה לניהול** | 🔴 הקישור "ניהול" בסרגל הניווט הצביע ל**עמוד ארגז-חול של perplexity.ai**, חי בפרודקשן. כל מבקר שלחץ נשלח לעמוד AI של צד שלישי. הופנה ל-`more30.com/admin`, שמסנן בעצמו — לזר הוא מציג מסך שער בן 250 תווים ולא תוכן. |
...
| **מצב כהה** | ~~חסר ב-13 מערכות.~~ **נסגר ב-7 מהן** (04, 15, 24, 27, 30, 31, 32) ו-21 התברר ככהה מלכתחילה. **נשארו 5: 02, 03, 06, 10, 35.** ראה הפירוט למטה. | 5 נותרו |
