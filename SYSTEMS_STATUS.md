...
> 12 סמל ו-17 חיזוקים** — **דלוק היום**. נרשם ככבוי ב-12/08, ומאז הופך. שלוש
> מערכות חיות היו רשומות שבורות תחת קריאה שכבר לא הייתה נכונה. הרשימה יורדת
> מתשע לשש: 01, 15, 21, 24, 30, 31.
>
...
>
> **שבעה פרויקטים עדיין שולחים מייל אל `localhost:3000`** — התאום של #198.
> **אף אחד מהם אינו מוגש בייצור** (נבדק מול תשעת ה-refs שהאתרים החיים נושאים;
> נבדק גם הפוך על `tltfpznyqxpuydgefmnp`, ששמו `chatzor-connect` בעוד
> `apps/16-chatzor-connect` נושא בקוד את הפורטל בלבד). נטושים, לא תקלה חיה —
> ולכן נרשמו ולא תוקנו.
>
