...
const SYSTEMS = {
  ...
  smel: {
    ...
    notes: [
      ...
      'תוקן בקישור מפורש, בלי שינוי בעיצוב. **ממתין לפריסה.**',
    ],
  },
  smachot: {
    title: '14 · שמחות פלוס',
    ...
    notes: [
      ...
      'קישור "מאגר GitHub" נמדד 232×20 — מתחת לרצפת 24px של WCAG 2.5.8, ואינו קישור בתוך משפט ולכן אינו פטור. `min-height:24px` כבר קיים במקור. **כתוב, ממתין לפריסה.**',
    ],
  },
  egod: {
    title: '15 · איגוד',
  ...
  mthbram: {
    ...
    notes: [
      ...
      '`FilterSelect` נשא את שמו רק דרך האפשרות הריקה, ולכן השדה הציג "נושא" עד שבחרו בו — ומאותו רגע הוכרז רק "גמרא", בלי לומר איזה מסנן זה. תוקן בשני העותקים (`LessonsDashboard`, `FindLesson`) יחד עם שני שדות חיפוש בלי שם. **ממתין לפריסה**, ולכן המדידה עדיין מראה 3.',
  ...
  mechiron: {
    ...
    notes: [
      'טופס יצירת הקשר הוא המקום היחיד בעמוד שבו מבקר מוסר פרטים, וארבעת שדותיו הוכרזו בלי שם. מי שמילא אותו בקורא מסך שמע "עריכה, חובה" ולא ידע אם מבקשים טלפון או אימייל. תוקן בשני המסלולים שמרנדרים אותו, עם `autoComplete` ועם `aria-hidden` על הכוכבית — `required` כבר מודיע על חובה, והכוכבית הוקראה באמצע השם. **ממתין לפריסה.**',
