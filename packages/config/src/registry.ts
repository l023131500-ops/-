...
export const REGISTRY: ProjectEntry[] = [
  ...
  { number: "06", slug: "kupot-holim", repo: "kupot-holim", name: "Kupot Holim", department: "health", category: "health", stage: "wip", live: true, isDeployed: true, supabaseProject: "csjekrvukbdznetsrodj", supabaseSchema: "public", deployTarget: "unknown", protected: false, note: "משתף csjekrvu עם bkalut-price/chizukim/smel." },
  ...
  { number: "10", slug: "bkalot-rights", repo: "bkalot-rights", name: "Bkalot Rights", department: "rights", category: "rights", stage: "wip", live: true, isDeployed: true, supabaseProject: "bieebmnmkffwbqlsfozh", supabaseSchema: "public", deployTarget: "unknown", protected: false, note: "משתף bieebmnm (igud)." },
  ...
  { number: "12", slug: "smel-ndln", repo: "smel-ndln", name: "Smel Ndln", department: "realestate", category: "realestate", stage: "wip", live: true, isDeployed: true, supabaseProject: "csjekrvukbdznetsrodj", supabaseSchema: "public", deployTarget: "unknown", protected: false, note: "נדל\"ן variant. משתף csjekrvu. לשקול מיזוג עם 32." },
  ...
  { number: "14", slug: "bsmachot-plus", repo: "bsmachot-plus", name: "Bsmachot Plus", department: "misc", category: "events", stage: "wip", live: true, isDeployed: true, supabaseProject: null, supabaseSchema: null, deployTarget: "unknown", protected: false, note: "אירועים/שמחות (36 קבצים)." },
  { number: "15", slug: "egod", repo: "egod", name: "egod", department: "torah", category: "hub", stage: "live", live: true, isDeployed: true, supabaseProject: "hkkkynyoigzlttpynoeo", supabaseSchema: "public", deployTarget: "lovable", protected: false, note: "נולד ב-Lovable. Supabase משלו (hkkky) — לא משותף עם torah-platform." },
  ...
  { number: "18", slug: "torah-editor-mvp", repo: "torah-editor-mvp", name: "Torah Editor MVP", department: "torah", category: "torah", stage: "wip", live: true, isDeployed: true, supabaseProject: "bieebmnmkffwbqlsfozh", supabaseSchema: "public", deployTarget: "unknown", protected: false, note: "OCR: Kraken/Transkribus/DictaLM/Anthropic. משתף bieebmnm." },
  ...
  { number: "22", slug: "get-your-rights", repo: "get-your-rights", name: "Get Your Rights", department: "rights", category: "rights", stage: "wip", live: true, isDeployed: true, supabaseProject: "trerolyveytzgksawrme", supabaseSchema: "public", deployTarget: "unknown", protected: false, note: "edge: leads-api/leads-webhook/n8n-notify/rights-agent. Supabase משלו (trerolyv)." },
  ...
  { number: "24", slug: "galilee-connect-hub", repo: "galilee-connect-hub", name: "Galilee Connect Hub", department: "community", category: "other", stage: "wip", live: true, isDeployed: true, supabaseProject: "mwljkonwdeuaahsigjdp", supabaseSchema: "public", deployTarget: "unknown", protected: false, note: "קהילתי. משתף mwljkonw עם chatzor." },
  ...
  { number: "26", slug: "modaot-studio", repo: "modaot-studio", name: "Modaot Studio", department: "torah", category: "advertising", stage: "wip", live: true, isDeployed: true, supabaseProject: null, supabaseSchema: null, deployTarget: "unknown", protected: false, note: "סטודיו AI: Anthropic/Gemini/Recraft. ללא Supabase." },
  { number: "27", slug: "bkalut-price", repo: "bkalut-price", name: "Bkalut Price", department: "bkalut", category: "commerce", stage: "wip", live: true, isDeployed: true, supabaseProject: "csjekrvukbdznetsrodj", supabaseSchema: "public", deployTarget: "unknown", protected: false, note: "משתף csjekrvu. 255 קבצים." },
  ...
  { number: "30", slug: "zchuyotpro-crm", repo: "zchuyotpro-crm", name: "ZchuyotPro CRM", department: "rights", category: "crm", stage: "wip", live: true, isDeployed: true, supabaseProject: "jhbeelzvjvhnkxldqvxx", supabaseSchema: "public", deployTarget: "unknown", protected: false, note: "CRM זכויות. Supabase משלו (jhbeelzv)." },
  { number: "31", slug: "hebrew-bridge-crm", repo: "hebrew-bridge-crm", name: "Hebrew Bridge CRM", department: "community", category: "crm", stage: "wip", live: true, isDeployed: true, supabaseProject: "ygaqqnuyfnumezxxmtbh", supabaseSchema: "public", deployTarget: "unknown", protected: false, note: "Supabase משלו (ygaqq). 155 קבצים." },
