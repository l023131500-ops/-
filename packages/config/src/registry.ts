...
export const REGISTRY: ProjectEntry[] = [
  ...
  { number: "40", slug: "gannenet", repo: "-", name: "גננת בקליק — מדף הגננת", category: "other", stage: "live", live: true, supabaseSchema: null, deployTarget: "railway", protected: false, note: "Kindergarten materials shelf in monorepo root gannenet-app/. 2,977 Drive files streamed via same-origin /api/drive proxy; in-site page selection (download/print); offline PWA; password-gated admin (hide files / trim pages). Served at more.30.com/40 (Netfree-approved). Railway: gannenet-app-production.up.railway.app. Set APP_BASE_PATH=/40 on the deployment when routed under the /40 subpath." },
];
