...
export const REGISTRY: ProjectEntry[] = [
  { number: "01", slug: "torah-platform", repo: "torah-platform", name: "Torah Platform (HUB, +egod)", category: "hub", stage: "live", live: true, supabaseSchema: "public", deployTarget: "lovable", protected: false, note: "Main hub; billing via Nedarim. Visual polish stays in Lovable." },
  { number: "02", slug: "igud-transcribe", repo: "igud-transcribe", name: "Igud Transcribe", category: "transcription", stage: "wip", live: false, supabaseSchema: null, deployTarget: "unknown", protected: false, note: "MISSING transcription API token — identify which (see CONNECTIONS.md)." },
  { number: "03", slug: "igud-ads", repo: "igud-ads", name: "Igud Ads", category: "advertising", stage: "live", live: true, supabaseSchema: null, deployTarget: "unknown", protected: false, note: "Revenue system (גובה)." },
  ...
  { number: "15", slug: "egod", repo: "egod", name: "egod (HUB pair with 01)", category: "hub", stage: "live", live: true, supabaseSchema: "public", deployTarget: "lovable", protected: false, note: "Born in Lovable; shares Supabase with torah-platform." },
  ...
  { number: "17", slug: "chizukim-transcribe", repo: "chizukim-transcribe", name: "Chizukim Transcribe", category: "transcription", stage: "wip", live: false, supabaseSchema: null, deployTarget: "unknown", protected: false, note: "Transcription system — verify token like igud-transcribe." },
