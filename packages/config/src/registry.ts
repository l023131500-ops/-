...
export const REGISTRY: ProjectEntry[] = [
  { number: "01", slug: "torah-platform", repo: "torah-platform", name: "Torah Platform (HUB, +egod)", category: "hub", stage: "live", live: true, supabaseProject: "bieebmnmkffwbqlsfozh", supabaseSchema: "public", deployTarget: "vercel", protected: false, note: "VERIFIED via .env.example: Vite on Vercel; Supabase bieebmnmkffwbqlsfozh ('bkalut-production'); Nedarim via Supabase Edge Functions (nedarim-webhook); born in Lovable. ⚠️ DISCREPANCY: connected hub uhnrgujbdxhhmoxcjria holds matching live tables — confirm which project production uses." },
  ...
  { number: "04", slug: "imud-torani", repo: "imud-torani", name: "Imud Torani", category: "torah", stage: "beta", live: true, supabaseProject: null, supabaseSchema: null, deployTarget: "railway", protected: false, note: "VERIFIED: Vite+Express (rest-express); LOCAL SQLite (data.db via Drizzle) — no Supabase, no API keys, no AI. Only optional PORT. Known bug: X-Visitor-Id header." },
